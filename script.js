...
/* ==========================================================================
   PERBAIKAN LOGIKA & WARNA TOMBOL NAVIGASI (MODUL 13, 14, 15)
   ========================================================================== */

// --- 1. MODUL LOMBA (Modul 13) ---
function perbaruiTombolNavigasiLomba(totalData) {
    ...
    const btnTerbaru = document.getElementById('btn-halaman-terbaru'); // Tombol Kiri
    const btnSebelumnya = document.getElementById('btn-halaman-sebelumnya'); // Tombol Kanan

    // Atur Tombol Terbaru (Kiri) -> Muncul hanya jika di halaman > 1
    if (btnTerbaru) {
        btnTerbaru.style.backgroundColor = '#D32F2F'; // Warna Merah
    ...
    // Atur Tombol Sebelumnya (Kanan) -> Muncul hanya jika belum mencapai halaman terakhir
    if (btnSebelumnya) {
        btnSebelumnya.style.backgroundColor = '#D32F2F'; // Warna Merah
...
function perbaruiTombolNavigasiProposal(totalData) {
    ...
    const btnTerbaru = document.getElementById('btn-prop-terbaru'); // Tombol Kiri
    const btnSebelumnya = document.getElementById('btn-prop-sebelumnya'); // Tombol Kanan

    // Atur Tombol Terbaru (Kiri)
    if (btnTerbaru) {
        btnTerbaru.style.backgroundColor = '#D32F2F'; // Warna Merah
        btnTerbaru.style.color = 'white';
...
function perbaruiTombolNavigasiSurat(totalData) {
    ...
    const btnTerbaru = document.getElementById('btn-surat-terbaru'); // Tombol Kiri
    const btnSebelumnya = document.getElementById('btn-surat-sebelumnya'); // Tombol Kanan
